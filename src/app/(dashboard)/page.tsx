...
import { DashboardCustomizer, WIDGETS } from "@/components/DashboardCustomizer";
...
import {
  Globe, Award, MousePointerClick, Bot, TrendingUp, TrendingDown, Activity, Settings2,
} from "lucide-react";
    ...
    <div className="p-6 space-y-6 print:p-2">
      ...
      <div className="flex items-center justify-between flex-wrap gap-2">
        ...
        <div className="flex items-center gap-2">
          <DashboardCustomizer visibility={visibility} onChange={setVisibility} />
          <PdfExport />
        </div>
      </div>
      ...
      {show("sov") && <ShareOfVoice />}

      {show("goal") && <GoalTracker />}

      {show("anomaly") && <AnomalyCards />}

      {show("gaps") && <KeywordGaps />}

      {show("ai") && <AIAnalysis period={period} />}
